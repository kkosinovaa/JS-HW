...
let clients = [
    ...
    new Client(3, 'Olena', 'Shevchenko', '<EMAIL>', '+380671234567', [
        new Product('Eggs', 80),
        new Product('Sugar', 120),
        new Product('Flour', 90)
    ]),
    ...
    new Client(5, 'Andriy', 'Bondar', '<EMAIL>', '+380931223344', [
        new Product('Tomatoes', 110),
        new Product('Cucumbers', 130),
        new Product('Onions', 70),
        new Product('Potatoes', 60)
    ]),

    new Client(6, 'Natalia', 'Hrytsenko', '<EMAIL>', '+380991445566', [
        new Product('Meat', 400),
    ...
    new Client(8, 'Kateryna', 'Lysenko', '<EMAIL>', '+380931667788', [
        new Product('Chocolate', 90),
        new Product('Cookies', 120),
        new Product('Candy', 50)
    ]),

    new Client(9, 'Serhiy', 'Danylenko', '<EMAIL>', '+380991778899', [
        new Product('Coffee', 250),
        new Product('Tea', 200)
    ]),

    new Client(10, 'Yulia', 'Melnyk', '<EMAIL>', '+380501889900', [
        new Product('Rice', 180),
        new Product('Pasta', 160),
        new Product('Oil', 220)
    ])
];
